...
<section id="choisir">
    <h3>Pourquoi nous choisir</h3>
        <div class="icons">
            ...
            <div class="content-icon">
                  ...
                  <img src="img/icons/world2.png" alt="monde" >
                    ...
                    <div class="content-icon">
                         <img src="img/icons/comm2.png" alt="communication">
                ...
                <div class="content-icon">
                         <img src="img/icons/money2.png" alt="argent">
                    ...
                    <div class="content-icon">
                         <img src="img/icons/insurance2.png" alt="assurance">
                     <p>Un problème 
    ...
    <section id="newsletter">
            ...
            <p>Ne tardez plus pour vous évader, recevez nos dernières offres</p>
                <form method="post" action="traitement.php" id="barre">
